...
const obj={name,nipt, address,email}
...
localStorage.setItem('businesses',JSON.stringify(obj))
  ...
  return (
    ...
    onSubmit={handleSubmit}>
        ...
        <div className="mb-3">
          <label>Address</label>
          <input     onChange={(e)=>setA(e.target.value)} type="text" className="form-control" placeholder="Address" />
        </div>
        <div className="mb-3">
          <label>Nipt</label>
          <input     onChange={(e)=>setN(e.target.value)} type="text" className="form-control" placeholder="Nipt" />
        </div>
        <div className="mb-3">
